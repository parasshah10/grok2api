...
class MCPLogFilter(logging.Filter):
    """MCP Log Filter - Filter out DEBUG logs containing large amounts of data"""

    def filter(self, record):
        # Filter out SSE logs containing raw byte data
...
class LoggerManager:
    ...
    def __init__(self):
        ...
        # Configure third-party library log levels to avoid excessive debug info
