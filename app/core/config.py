...
class ConfigManager:
    ...
    def load(self, section: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"[Setting] Failed to load config: {e}")
    
    async def reload(self) -> None:
        """Reload configuration (used after syncing from storage)"""
    ...
    async def save(self, global_config: Dict[str, Any] = None, grok_config: Dict[str, Any] = None) -> None:
        ...
        if not self._storage:
            ...
            if grok_config:
                # Handle cf_clearance, save after removing prefix
    ...
    def get_cache_proxy(self) -> str:
        ...
        # If cache_proxy_url is set, use it first
        if cache_proxy:
            return cache_proxy
